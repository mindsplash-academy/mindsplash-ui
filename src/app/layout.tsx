  ...
  return (
    <html lang="en">
      ...
      <body className={`${lato.variable} antialiased relative`}>
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-Q3M2TYQPMZ"
